...
const common = {
  ...
  setI18data() {
    ...
    this.i18data.downloadNotificationMaxCountSetting = this.loadI18nMessage('downloadNotificationMaxCountSetting')
    this.i18data.downloadNotificationMaxCountDescSetting = this.loadI18nMessage('downloadNotificationMaxCountDescSetting')
